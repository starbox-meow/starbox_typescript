...
export class AddSamplesPrompt {
    ...
    private readonly _instructionsLink: HTMLAnchorElement = a({ href: "#" }, "Here's more information and some instructions on how to use custom samples in StarBox.");
    private readonly _description: HTMLDivElement = div(
        div({ style: "margin-bottom: 0.5em; -webkit-user-select: text; -moz-user-select: text; -ms-user-select: text; user-select: text; cursor: text;" },
            "In order to use the old StarBox samples, you should add ",
            code("legacySamples"),
    ...
    private readonly _instructionsArea: HTMLDivElement = div(
        ...
        div({ style: "margin-top: 0.5em; margin-bottom: 0.5em;" },
            "In StarBox, custom samples are loaded from arbitrary URLs.",
        ),
