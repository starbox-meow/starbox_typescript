...
export class Song {
    ...
    public toBase64String(): string {
        ...
        buffer.push(base64IntToCharCode[Song._latestStarBoxVersion]);
    ...
    public fromBase64String(compressed: string, jsonFormat: string = "auto"): void {
        ...
        if (fromStarBox && (version == -1 || version > Song._latestStarBoxVersion || version < Song._oldestStarBoxVersion)) return;
        ...
        if (fromStarBox || fromSlarmoosBox || fromUltraBox || fromGoldBox) {
        ...
        while (charIndex < compressed.length) switch (command = compressed.charCodeAt(charIndex++)) {
            ...
            case SongTagCode.rhythm: {
                if (!fromUltraBox && !fromSlarmoosBox && !fromStarBox) {
            ...
            case SongTagCode.wave: {
                if (beforeThree && fromBeepBox) {
                    ...
                    if (this.channels[instrumentChannelIterator].instruments[instrumentIndexIterator].type == InstrumentType.noise) {
                        ...
                        if (fromStarBox || fromSlarmoosBox || fromUltraBox) {
            ...
            case SongTagCode.eqFilter: {
                if ((beforeNine && fromBeepBox) || (beforeFive && fromJummBox) || (beforeFour && fromGoldBox)) {
                    ...
                    if (fromBeepBox || typeCheck == 0) {
                        ...
                        if (fromStarBox || fromJummBox || fromGoldBox || fromUltraBox || fromSlarmoosBox)
                        ...
                        if ((fromJummBox && !beforeFive) || (fromGoldBox && !beforeFour) || fromUltraBox || fromSlarmoosBox || fromStarBox) {
            ...
            case SongTagCode.drumsetEnvelopes: {
                ...
                const pregoldToEnvelope: number[] = [0, 1, 2, 4, 5, 6, 8, 9, 10, 12, 13, 14, 16, 17, 18, 19, 20, 21, 23, 24, 25, 27, 28, 29, 32, 33, 34, 31, 11];
                if ((beforeNine && fromBeepBox) || (beforeFive && fromJummBox) || (beforeFour && fromGoldBox)) {
                    if ((beforeTwo && fromGoldBox) || (!fromGoldBox && !fromUltraBox && !fromSlarmoosBox && !fromStarBox)) {

                    }
                    if (instrument.type == InstrumentType.drumset) {
                        for (let i: number = 0; i < Config.drumCount; i++) {
                            let aa: number = base64CharCodeToInt[compressed.charCodeAt(charIndex++)];
                            if ((beforeTwo && fromGoldBox) || (!fromGoldBox && !fromUltraBox && !fromSlarmoosBox && !fromStarBox)) aa = pregoldToEnvelope[aa];
                    ...
                    for (let i: number = 0; i < Config.drumCount; i++) {
                        let aa: number = base64CharCodeToInt[compressed.charCodeAt(charIndex++)];
                        if ((beforeTwo && fromGoldBox) || (!fromGoldBox && !fromUltraBox && !fromSlarmoosBox && !fromStarBox)) aa = pregoldToEnvelope[aa];
                        if (!fromSlarmoosBox && !fromStarBox && aa >= 2) aa++; //2 for pitch
            ...
            case SongTagCode.pulseWidth: {
                ...
                if ((fromUltraBox && !beforeFour) || fromSlarmoosBox || fromStarBox) {
            ...
            case SongTagCode.fadeInOut: {
                if ((beforeNine && fromBeepBox) || ((fromJummBox && beforeFive) || (beforeFour && fromGoldBox))) {
                    ...
                    } else if ((beforeFour && !fromGoldBox && !fromUltraBox && !fromSlarmoosBox && !fromStarBox) || fromBeepBox) {
                        const settings = legacySettings[clamp(0, legacySettings.length, base64CharCodeToInt[compressed.charCodeAt(charIndex++)])];
                        const instrument: Instrument = this.channels[instrumentChannelIterator].instruments[instrumentIndexIterator];
                        instrument.fadeIn = Synth.secondsToFadeInSetting(settings.fadeInSeconds);
                        instrument.fadeOut = Synth.ticksToFadeOutSetting(settings.fadeOutTicks);
                    ...
                    if (fromJummBox || fromGoldBox || fromUltraBox || fromSlarmoosBox || fromStarBox)
                        instrument.clicklessTransition = base64CharCodeToInt[compressed.charCodeAt(charIndex++)] ? true : false;
                }
            } break;
            case SongTagCode.songEq: { //deprecated vibrato tag repurposed for songEq
                if ((beforeNine && fromBeepBox) || ((fromJummBox && beforeFive) || (beforeFour && fromGoldBox))) {
                    ...
                    // songeq
                    if (fromStarBox || (fromSlarmoosBox && !beforeFour)) { //double check that it's from a valid version
            ...
            case SongTagCode.unison: {
                if (beforeThree && fromBeepBox) {
                    ...
                    const unisonLength = ((beforeFive || !fromSlarmoosBox) && !fromStarBox) ? 27 : Config.unisons.length; //27 was the old length before I added >2 voice presets

                    if (((fromUltraBox && !beforeFive) || fromSlarmoosBox || fromStarBox) && (instrument.unison == unisonLength)) {
                ...
                if ((beforeNine && fromBeepBox) || ((fromJummBox && beforeFive) || (beforeFour && fromGoldBox))) {
                    ...
                    if (effectsIncludeNoteFilter(instrument.effects)) {
                        ...
                        if (fromBeepBox || typeCheck == 0) {
                            ...
                            if ((fromJummBox && !beforeFive) || (fromGoldBox) || (fromUltraBox) || (fromSlarmoosBox) || fromStarBox) {
                                let usingSubFilterBitfield: number = (base64CharCodeToInt[compressed.charCodeAt(charIndex++)] << 6) | (base64CharCodeToInt[compressed.charCodeAt(charIndex++)]);
                                for (let j: number = 0; j < Config.filterMorphCount - 1; j++) {
                                    if (usingSubFilterBitfield & (1 << j)) {
                                        // Number of control points
                    ...
                    if (effectsIncludeChord(instrument.effects)) {
                        ...
                        if (instrument.chord == Config.chords.dictionary["arpeggio"].index && (fromJummBox || fromGoldBox || fromUltraBox || fromSlarmoosBox || fromStarBox)) {
                            instrument.arpeggioSpeed = base64CharCodeToInt[compressed.charCodeAt(charIndex++)];
                            instrument.fastTwoNoteArp = (base64CharCodeToInt[compressed.charCodeAt(charIndex++)]) ? true : false;
                        }
                        if (instrument.chord == Config.chords.dictionary["monophonic"].index && ((fromSlarmoosBox && !beforeFive) || fromStarBox)) {
                    ...
                    if (effectsIncludeVibrato(instrument.effects)) {
                        ...
                        // Custom vibrato
                        if (instrument.vibrato == Config.vibratos.length && (fromJummBox || fromGoldBox || fromUltraBox || fromSlarmoosBox || fromStarBox)) {
                    ...
                    if (effectsIncludePanning(instrument.effects)) {
                        ...
                        if ((fromJummBox && !beforeTwo) || fromGoldBox || fromUltraBox || fromSlarmoosBox || fromStarBox)
            ...
            case SongTagCode.pan: {
                if (beforeNine && fromBeepBox) {
                    ...
                    if (fromJummBox && !beforeThree || fromGoldBox || fromUltraBox || fromSlarmoosBox || fromStarBox) {
                        instrument.panDelay = base64CharCodeToInt[compressed.charCodeAt(charIndex++)];
                    }
                } else {
                    // Do nothing? This song tag code is deprecated for now.
            ...
            case SongTagCode.channelNames: {
                for (let channel: number = 0; channel < this.getChannelCount(); channel++) {
                    ...
                    if (beforeFour && !fromGoldBox && !fromUltraBox && !fromSlarmoosBox && !fromStarBox)
            ...
            case SongTagCode.operatorFrequencies: {
                ...
                else if (!fromGoldBox && !fromUltraBox && !fromSlarmoosBox && !fromStarBox) {
            ...
            case SongTagCode.envelopes: {
                ...
                if ((beforeNine && fromBeepBox) || (beforeFive && fromJummBox) || (beforeFour && fromGoldBox)) {
                    ...
                    if ((fromJummBox && !beforeSix) || (fromUltraBox && !beforeFive) || (fromSlarmoosBox) || fromStarBox) {
                        ...
                        if ((!fromSlarmoosBox || beforeFive) && !fromStarBox) {
                    ...
                    for (let i: number = 0; i < envelopeCount; i++) {
                        ...
                        const envelope: number = clamp(0, ((fromStarBox || (fromSlarmoosBox && !beforeThree) || updatedEnvelopes) ? Config.newEnvelopes.length : Config.envelopes.length), aa);
                        let pitchEnvelopeStart: number = 0;
                        let pitchEnvelopeEnd: number = Config.maxPitch;
                        let envelopeInverse: boolean = false;
                        perEnvelopeSpeed = (fromStarBox || (fromSlarmoosBox && !beforeThree)) ? Config.newEnvelopes[envelope].speed : perEnvelopeSpeed;
                        ...
                        if (fromStarBox || (fromSlarmoosBox && !beforeFour)) {
                        ...
                        if ((!fromSlarmoosBox && !fromStarBox) || beforeFour) { //update tremolo2
                            if (isTremolo2) {
                        ...
                        while (curPart < this.beatsPerBar * Config.partsPerBeat + (+isModChannel)) {
                            ...
                            if (!useOldShape && !newNote) {
                                ...
                                if (useOldShape) {
                                    ...
                                    } else if (fromStarBox && !beforeThree) {
                                ...
                                if (note.start == 0) {
                                    if (!((beforeNine && fromBeepBox) || (beforeFive && fromJummBox) || (beforeFour && fromGoldBox))) {
                                        ...
                                        if ((beforeFour && !fromUltraBox && !fromSlarmoosBox && !fromStarBox) || fromBeepBox) {
                                            note.continuesLastPattern = false;
                                        } else {
    ...
    public toJsonObject(enableIntro: boolean = true, loopCount: number = 1, enableOutro: boolean = true): Object {
        ...
        const result: any = {
            "name": this.title,
            "format": Song._format,
            "version": Song._latestStarBoxVersion,
